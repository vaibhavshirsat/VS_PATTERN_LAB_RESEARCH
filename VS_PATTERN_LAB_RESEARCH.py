...
def fibonacci_elliott_research(df):
    ...
    metrics={"Status":"Heuristic swing map","Swing direction":direction,"Swing start":round(a[1],2),
             "Swing end":round(b[1],2),"Latest close":round(float(x.Close.iloc[-1]),2),
             "Swing size":round(span,2),"Wave count":"Not confirmed — swing pivots only",
